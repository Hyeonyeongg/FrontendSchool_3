...
function ProductList(){
  ...
  //그냥 then으로 데이터넘겨주면 안돼? 왜냐면 일반변수는 렌더링을 다시 하지 않음. 이렇게사용하면 렌더링을 다시함. requets의 요청이 성공하면 함수가 호출되니까 다시 렌더링 됨. 무한반복이 일어남. setProductListData를 호출하면 productData를 하면 함수를 재랜더링. 그럼 ProductList를 또 호출하니까 다시 데이터받고 또 호출해서 반복.
